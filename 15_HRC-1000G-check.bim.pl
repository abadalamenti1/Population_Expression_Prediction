...
my $kg_file =  '/home/wheelerlab1/Data/preImputation-check/1000GP_Phase3_combined.legend';
...
print L "\nPosition Matches\n ID matches $referenceused $idmatch\n ID Doesn't match $referenceused $idmismatch\n Total Position Matches $pos_check\nID Match\n Different position to $referenceused $
